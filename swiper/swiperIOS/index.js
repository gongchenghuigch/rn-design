...
class Swiper extends Component {
    ...
    initState(props, updateIndex = false) {
        ...
        initState.offset[initState.dir] =
            initState.dir === "x" ? initState.width * props.index : initState.height * props.index;
    ...
    render() {
        ...
        if (!width || !height) {
            return React.cloneElement(children[0], { onLayout: this.onLayout });
        }
        ...
        return (
            <View
                style={[styles.container, containerStyle, { width, height }]}
                onLayout={this.onLayout}>
                {this.renderScrollView(pages)}
                {showsPagination && renderPagination(index, total, this)}
            </View>
        );
    }
}
