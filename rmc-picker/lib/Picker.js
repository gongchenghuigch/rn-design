            ...
            value: function render() {
                ...
                var map = function map(item) {
                    ...
                    return _react2.default.createElement(
                        "div",
                        {
                            style: (0, _extends3.default)({}, itemStyle, style),
                            className:
                ...
                var items = _react2.default.Children
                    ? _react2.default.Children.map(children, map)
                    : [].concat(children).map(map);
                var pickerCls = ((_pickerCls = {}),
                (0, _defineProperty3.default)(_pickerCls, props.className, !!props.className),
                (0, _defineProperty3.default)(_pickerCls, prefixCls, true),
                _pickerCls);
                return _react2.default.createElement(
                    "div",
                    {
